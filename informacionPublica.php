...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>INFORMACION PUBLICA-ASORCO</title>
    ...
    <body>
        ...
        <!-- <a href="archivo/subidos/Documentos/Frases.pdf" target="_blank">Abrir PDF</a> -->
        <!-- <embed src="archivo/subidos/Documentos/Frases.pdf" width="600" height="500" type="application/pdf"> -->
        <!-- <iframe src="archivo/subidos/Documentos/Frases.pdf" width="600" height="500"></iframe> -->
        <div class="container mt-5">
            <!-- <h1 class="text-center">Abrir PDF en una nueva pestaña</h1> -->
        </div>

        <!-- Navbar & Hero Start -->
        <div class="container-fluid nav-bar-asorco px-0 px-lg-4 py-lg-0">
            <div class="container">
                <nav class="navbar navbar-expand-lg navbar-light">
                    <a href="#" class="navbar-brand p-0">
                        <h1 class="text-primary mb-0">
                            <i class="fab fa-slack me-2"></i> ASORCO
                        </h1>
                    ...
                    <div class="collapse navbar-collapse" id="navbarCollapse">
                        <div class="navbar-nav mx-0 mx-lg-auto">
                            ...
                            >
                            <a
                                href="informacionPublica.html"
                                class="nav-item nav-link active"
                                >Informacion Publica</a
                            >
                        </div>
                    </div>
                    <div class="d-none d-xl-flex flex-shrink-0 ps-4">
                        ...
                        <div class="d-flex flex-column ms-3">
                            <span style="color: var(--primer-color)"
                                >Escribinos al</span
                            >
        ...
        >
            <div class="modal-dialog modal-fullscreen">
                <div class="modal-content rounded-0">
                    ...
                    <div
                        class="modal-body d-flex align-items-center bg-primary"
                    >
        ...
        <div class="container-fluid service py-5">
            <div class="container py-5">
                ...
                >
                    <h1 class="display-4 mb-4">Titulo Test</h1>
                </div>
                <div class="row g-4 justify-content-center">
                        <?php
                        include "retornarVistaPrevia.php";
                        $host = "localhost";
                        ...
                        $sql = "SELECT
                        nombre_mostrar ,
                        CONCAT('archivo/subidos/',nombre_archivo) as url FROM
                        archivos";
                        $stmt = $pdo->query($sql);
                        if ($stmt->rowCount() > 0) {
                            while ($row = $stmt->fetch()) {
                                echo retornarVistaPrevia(
                                    $row["nombre_mostrar"],
                                    $row["url"]
                                );
                            }
                                ...
                                <div class="col-md-6 col-lg-6 col-xl-5">
                                    <div class="footer-item">
                                        <a href="index.html" class="p-0">
                                            <h3 class="text-white">
                                                <i class="fab fa-slack me-3"></i
                                                >ASORCO
                                            </h3>
                                            <!-- <img src="img/logo.png" alt="Logo"> -->
                                        </a>
                                        <p class="text-white mb-4">
                                            Asociacion de sordos de Coronel
                                            Oviedo
                                        </p>
                                        <div class="footer-btn d-flex">
                                            <a
                                                class="btn btn-md-square rounded-circle me-3"
                                                href="https://www.facebook.com/asorco"
                                                ><i
                                ...
                                <div class="col-md-6 col-lg-6 col-xl-3">
                                    <div class="footer-item">
                                        ...
                                        <a href="contact.html"
                                            ...
                                            >Contactos</a
                                        >
                                        <a href="informacionPublica.html"
                                            ><i
                                                class="fas fa-angle-right me-2"
                                            ></i
                                            >Informacion Publica</a
